...
class Settings:
    ...
    def __init__(self, server, username, instance_id, instance_name, instance_token):
        self.server = server
    ...
    @staticmethod
    def create(server, username, instance_id, instance_name, instance_token):
        settings = Settings(server, username, instance_id, instance_name, instance_token)
